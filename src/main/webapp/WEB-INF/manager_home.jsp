...
<main class="main-content">
  <div class="page-heading">
    ...
    <p class="page-lead">
      Manage task assignments, monitor projects and inspect collaborators from a single page.
    </p>
  </div>
  ...
  <section data-view="assignment">
    <div class="manager-home-grid assignment-panel">
      <div class="form-card">
        ...
        <form method="post" id="assignment-form">
          <div class="field">
            ...
            <div class="select-wrapper">
              <select name="project_id" id="assignment-project-id" required></select>
            </div>
            <span class="field-error" id="project-id-error" hidden="hidden"></span>
          </div>

          <div class="field">
            <label for="assignment-wp-id">Work Package</label>
            <div class="select-wrapper">
              <select name="wp_id" id="assignment-wp-id" required></select>
            </div>
            <span class="field-error" id="wp-id-error" hidden="hidden"></span>
          </div>

          <div class="field">
            <label for="assignment-task-id">Task</label>
            <div class="select-wrapper">
              <select name="task_id" id="assignment-task-id" required></select>
            </div>
        ...
        <div class="section-divider" id="assign-project-section" style="padding-top: var(--space-5); margin-top: var(--space-2);">
          <p class="field-hint">
  ...
  <section data-view="projects" hidden>
    <div class="verify-layout">
      <aside class="project-list-panel">
        <div class="panel-header">Project monitoring</div>
        <div class="empty-state" id="project-monitor-empty">
          <p>No managed projects found.</p>
        </div>
        <ul class="project-nav" id="project-monitor-nav" hidden="hidden"></ul>
      </aside>

      <section class="project-detail-panel">
        <div class="detail-placeholder" id="project-monitor-placeholder">
          <p>Select a project to inspect planned and worked hours month by month.</p>
        </div>
        <div id="project-monitor-details" hidden="hidden"></div>
      </section>
    </div>
  </section>

  <section data-view="collaborators" hidden>
    <div class="verify-layout">
      <aside class="project-list-panel">
        <div class="panel-header">Collaborator monitoring</div>
        <div class="empty-state" id="collaborator-monitor-empty">
          <p>No collaborators found for your projects.</p>
        </div>
        <ul class="project-nav" id="collaborator-monitor-nav" hidden="hidden"></ul>
      </aside>

      <section class="project-detail-panel">
        <div class="detail-placeholder" id="collaborator-monitor-placeholder">
          <p>Select a collaborator to inspect worked hours across your projects.</p>
        </div>
        <div id="collaborator-monitor-details" hidden="hidden"></div>
      </section>
    </div>
  </section>
</main>
